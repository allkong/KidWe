...
|                                                              |                                                          |                                                      |                                                      |
| :----------------------------------------------------------: | :------------------------------------------------------: | :--------------------------------------------------: | :--------------------------------------------------: |
| <img src="images/선생_알림장(자동입력).gif" width="250px" /> | <img src="images/선생_공지사항등록.gif" width="250px" /> | <img src="images/선생_메모입력.gif" width="250px" /> | <img src="images/원장_메뉴등록.gif" width="250px" /> |
|                       알림장 자동생성                        |                      공지사항 등록                       |                      메모 등록                       |                      식단 등록                       |
| <img src="images/선생_알림장(자동입력).gif" width="250px" /> | <img src="images/선생_공지사항등록.gif" width="250px" /> | <img src="images/선생_메모입력.gif" width="250px" /> | <img src="images/원장_메뉴등록.gif" width="250px" /> |
|                       알림장 자동생성                        |                      공지사항 등록                       |                      메모 등록                       |                      식단 등록                       |
...
- **MySQL & MongoDB**
  - 데이터의 특성에 맞게 최적화된 DB를 사용하기 위해 2개로 나누어서 관리하였다.
  - MySQL은 관계형 데이터베이스로서 구조화된 데이터를 관리하는데 적합하다.
  - MongoDB는 비정형 데이터인 알림장, 메모 데이터를 저장하기에 적합하다.
  - 두 DB 간 상호작용하는 정보가 없고, 요청하는 횟수가 잦지 않아 분리하였다.
- **PWA**
  - Kidwe 서비스는 대부분 모바일 환경에서 이용하는 것이 편리하다 생각했다.
