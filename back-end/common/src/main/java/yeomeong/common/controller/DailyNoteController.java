...
public class DailyNoteController {
    ...
    @Operation(summary = "월별 알림장 조회 API", description = "학부모 : kid_id로 월별 알림장을 조회해 List로 반환합니다.")
    ...
    @Operation(summary = "월별 알림장 조회 API", description = "선생, 원장 : ban_id로 월별 알림장을 조회해 List로 반환합니다.")
