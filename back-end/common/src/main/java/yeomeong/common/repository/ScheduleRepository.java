...
public interface ScheduleRepository extends JpaRepository<Schedule,Long> {
    ...
    List<Schedule> findAllByBan_Kindergarten_IdAndEventDateAndScheduleTypeOrderByEventTimeDesc(Long kindergartenId, LocalDate localDate, Schedule.ScheduleType type);
